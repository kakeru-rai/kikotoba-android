...
import net.snow69it.listeningworkout.article.ArticleApi;
...
public class DictationHtml {

    public static DictationHtml newInstance(Context context, Article targetArticle) throws IOException {
        ...
        return new DictationHtml(targetArticle, translatedArticle, htmlTmpl);
    }
    ...
    public DictationHtml(Article targetArticle, Article translatedArticle, String htmlTmpl) {
